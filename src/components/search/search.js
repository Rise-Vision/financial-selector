...
.component('instrumentTypeList', stockListsComponent)
.component('searchResults', searchResultsComponent)
.component('instrumentTypePicker', instrumentTypePickerComponent)
.service('instrumentTypeService', instrumentTypeService)
.service('userInstrumentService', userInstrumentService)
